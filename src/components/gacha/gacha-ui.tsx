...
const MainContent = ({isGacha, isInventory, isRanking, handleGachaClick, connected, mintItem, showModal, gachaResult, onClose, onRetry, dbAccount, creditAccount, setDbAccount, setCreditAccount}: {
  isGacha: boolean, 
  isInventory: boolean, 
  isRanking: boolean, 
