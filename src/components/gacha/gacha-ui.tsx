    ...
    return (
        <>
            <div className={`flex flex-col w-full items-center justify-${isInventory ? 'between' : 'end'}`}>
                ...
                />
                <LeftMenu isGacha={isGacha} isInventory={isInventory} isRanking={isRanking} setIsGacha={setIsGacha} setIsInventory={setIsInventory} setIsRanking={setIsRanking} connected={connected} handleGachaClick={handleGachaClick} setGachaResult={setGachaResult} />
            </div>
...
const LeftMenu = ({ isGacha, isInventory, isRanking, setIsGacha, setIsInventory, setIsRanking, connected, handleGachaClick, setGachaResult }: { isGacha: boolean, isInventory: boolean, isRanking: boolean, setIsGacha: (isGacha: boolean) => void, setIsInventory: (isInventory: boolean) => void, setIsRanking: (isRanking: boolean) => void, connected: boolean, handleGachaClick: () => void, setGachaResult: (gachaResult: any) => void }) => {
    return (
